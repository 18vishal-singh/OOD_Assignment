...
//		System.out.println(" b.f() :" + b.f() + " | b.g() :" + b.g() + " | b.p(1) :" + b.p(1) + " | b.q(2) :" + b.q(2));

		B2 b2 = new B2();
		System.out.println(b2.f() + b2.g() - b2.p(1) + b2.q(2));
//		System.out.println(
//				" b2.f() :" + b2.f() + " | b2.g() :" + b2.g() + " | b2.p(1) :" + b2.p(1) + " | b2.q(2) :" + b2.q(2));

		D d = new D();
		System.out.println(d.f() + d.g() - d.h() + d.p(1) - d.q(2) + d.r());
//		System.out.println(" d.f() :" + d.f() + " | d.g() :" + d.g() + " | d.h() :" + d.h() + " | d.p(1) :" + d.p(1)
//				+ " | d.q(2) :" + d.q(2) + " | d.r() :" + d.r());

		D2 d2 = new D2();
		System.out.println(d2.f() + d2.g() - d2.h() + d2.p(1) - d2.q(2) + d2.r());
//		System.out.println(" d2.f() :" + d2.f() + " | d2.g() :" + d2.g() + " | d2.h() :" + d2.h() + " | d2.p(1) :"
//				+ d2.p(1) + " | d2.q(2) :" + d2.q(2) + " | d2.r() :" + d2.r());
...
//		System.out.println(" e.f() :" + e.f() + " | e.g() :" + e.g() + " | e.h() :" + e.h() + " | e.p(1) :" + e.p(1)
//				+ " | e.q(2) :" + e.q(2) + " | e.r() :" + e.r() + " | e.k(100) :" + e.k(100));

		E2 e2 = new E2();
		System.out.println(e2.f() - e2.g() + e2.h() - e2.p(1) + e2.q(2) - e2.r() + e2.k(100));
//		System.out.println(" e2.f() :" + e2.f() + " | e2.g() :" + e2.g() + " | e2.h() :" + e2.h() + " | e2.p(1) :"
//				+ e2.p(1) + " | e2.q(2) :" + e2.q(2) + " | e2.r() :" + e2.r() + " | e2.k(100) :" + e2.k(100));

		F f = new F();
		System.out.println(f.f() + f.g() + f.h() + f.p(1) - f.q(2) - f.r() - f.j(10) + f.l(100));
//		System.out.println(" f.f() :" + f.f() + " | f.g() :" + f.g() + " | f.h() :" + f.h() + " | f.p(1) :" + f.p(1)
//				+ " | f.q(2) :" + f.q(2) + " | f.r() :" + f.r() + " | f.j(10) :" + f.j(10) + " | f.l(100) :"
//				+ f.l(100));

		F2 f2 = new F2();
		System.out.println(f2.f() + f2.g() + f2.h() + f2.p(1) - f2.q(2) - f2.r() - f2.j(10) + f2.l(100));
//		System.out.println(" f2.f() :" + f2.f() + " | f2.g() :" + f2.g() + " | f2.h() :" + f2.h() + " | f2.p(1) :"
//				+ f2.p(1) + " | f2.q(2) :" + f2.q(2) + " | f2.r() :" + f2.r() + " | f2.j(10) :" + f2.j(10)
//				+ " | f2.l(100) :" + f2.l(100));
	}
}
